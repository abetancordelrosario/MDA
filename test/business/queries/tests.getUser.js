...
describe("Business / Queries / User", function()
{
    ...
    it("Should return user info", async() =>
    {
        ...
        // Coger hora actual const fecha = (new Date(Date.now())).toISOString();

        await testSetupContents().givenAnyUser({name: "nombre1", surname: "apellidos1", display_name: "display1", email: "email1@gmail.com", phone: "123 456 789", passwd: password, rol: 0, points: 5, organization: "ULPGC", time_stamp: "2022-03-24 12:13:25"});
        let anyUserInfo = {
